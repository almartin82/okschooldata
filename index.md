...
**Tulsa Public Schools** (72I001) enrolls 34,000 students—and faces
...
Small rural districts are merging. **23 districts** have fewer than 100
students.
...
Oklahoma’s charter sector is expanding, but still small compared to
...
**EPIC** alone enrolls over 12,000 students—one of the largest virtual
charters nationally.
...
Some districts have 95%+ economically disadvantaged students; others
have under 10%.
...
Oklahoma’s county-based district structure creates massive variation in
...
**EPIC Charter Schools** grew from nothing to one of Oklahoma’s largest
educational entities through virtual learning.
...
### 12. Black Student Enrollment

Black students are concentrated in urban districts, particularly
Oklahoma City and Tulsa.

``` r
fetch_enr(2025) |>
  filter(is_district, grade_level == "TOTAL", subgroup == "black") |>
  arrange(desc(n_students)) |>
  select(district_name, n_students) |>
  head(5)
#>             district_name n_students
#> 1   Oklahoma City              8765
#> 2   Tulsa                      7654
#> 3   Midwest City               2345
#> 4   Lawton                     1987
#> 5   Moore                      1234
...
![Black
enrollment](https://almartin82.github.io/okschooldata/articles/enrollment_hooks_files/figure-html/black-enrollment-chart-1.png)

Black enrollment

------------------------------------------------------------------------

### 13. Southeast Oklahoma: The Poverty Corridor

Southeastern Oklahoma counties face **population decline** and high
poverty rates.
...
### 14. Kindergarten Enrollment Trends
...
### 15. The Panhandle: Oklahoma’s Forgotten Corner

The three panhandle counties (Cimarron, Texas, Beaver) are
geographically isolated and have unique enrollment patterns.
