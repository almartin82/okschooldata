...
Downloads and processes enrollment data from the Oklahoma State
Department of Education's public data files.
...
district_id, site_id, names, and enrollment counts by demographic/grade.
