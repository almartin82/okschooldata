...
| Python tests | `pytest tests/test_pyokschooldata.py -v`                                       | Python wrapper works correctly                 |
...
system("pip install -e ./pyokschooldata && pytest tests/test_pyokschooldata.py -v")
...
0 errors, 0 warnings - \[ \] `pytest tests/test_pyokschooldata.py` — all
tests pass - \[ \]
