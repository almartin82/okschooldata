...
Python wrapper for Oklahoma school enrollment data.

This is a thin rpy2 wrapper around the [okschooldata](https://github.com/almartin82/okschooldata) R package. It provides the same functionality but returns pandas DataFrames.

## Requirements

- Python 3.9+
- R 4.0+
- The `okschooldata` R package installed
...
# In R:
# remotes::install_github("almartin82/okschooldata")

# Then install the Python package
pip install pyokschooldata
```
